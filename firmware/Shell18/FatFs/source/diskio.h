...
// variable used for the file and storage operations
FATFS FF;

// Definitions of physical drive number for each drive
#define DEV_NUL		0	// NULL device
#define DEV_IFS		1	// internal flash disk
#define DEV_RAM		2	// internal RAM disk
#define DEV_SD1		3	// external SD card 1
#define DEV_SD2		4	// external SD card 2
#define DEV_SD3		5	// external SD card 2
#define DEV_SD4		6	// external SD card 2
